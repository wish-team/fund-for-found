...
import AboutPage from "@/components/features/creators/about-section/AboutPage";
import CreatorBanner from "@/components/features/creators/banner/CreatorBanner";
import { TierManagement } from "@/components/features/creators/contributors/TierManagement";
import FAQ from "@/components/features/creators/faq-section/FAQsection";
import TeamMemberInvite from "@/components/features/creators/team-invite/TeamMemberInvite";
...
const CreatorProfile = () => {
  ...
  return (
    <div className="flex flex-col gap-20">
      ...
      <div ref={topBackersRef}>{/* Top Backers & Contributors content */}</div>
      <div ref={faqRef}>
        <FAQ />
      </div>
      <div ref={updatesRef}>
