...
export const SocialInputField: React.FC<SocialInputFieldProps> = React.memo(
  ({
    id,
    onRemove,
    onChange,
    ...
    const [selectedKey, setSelectedKey] = useState<SocialPlatformKey>(
      initialPlatform as SocialPlatformKey
    );
        ...
        <div className="relative w-full md:w-4/12">
          ...
          >
            <span className="flex items-center gap-2">
              {SelectedIcon && (
                <SelectedIcon className="text-gray4" size={20} />
              )}
