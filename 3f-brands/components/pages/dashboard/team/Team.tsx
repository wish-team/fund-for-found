...
const Team = () => {
  return (
    <section>
        <TeamMemberInvite />
        <p className="text-sm text-justify text-gray3 py-2"><strong>Teammates </strong>are shown as part of the team on your page but do not have admin access or get notifications. They have profile page on the platform.</p>
